...
# BlanketType.create(blanket_type: "sheet")
# BlanketType.create(blanket_type: "rainsheet")
# BlanketType.create(blanket_type: "cooler")
# BlanketType.create(blanket_type: "quarter sheet")
